...
// Legirovanie.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLegirovanieApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLegirovanieApp

CLegirovanieApp::CLegirovanieApp()
{
...
// Единственный объект CLegirovanieApp

CLegirovanieApp theApp;


// Инициализация CLegirovanieApp

BOOL CLegirovanieApp::InitInstance()
{
